...
/* harmony export */ });
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(268);
/* harmony import */ var immer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(902);
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(222);
/* harmony import */ var _reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(791);
/* harmony import */ var reselect__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(815);
    ...
    var updateQueryData = function (endpointName, args, updateRecipe, updateProvided) {
        ...
        return function (dispatch, getState) {
            ...
            if ("data" in currentState) {
                if ((0,immer__WEBPACK_IMPORTED_MODULE_1__/* .isDraftable */ .o$)(currentState.data)) {
                    var _l = (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .produceWithPatches */ .aS)(currentState.data, updateRecipe), value = _l[0], patches = _l[1], inversePatches = _l[2];
...
function buildSlice(_j) {
            ...
            queryResultPatched: {
                reducer: function (draft, _j) {
                    ...
                    updateQuerySubstateIfExists(draft, queryCacheKey, function (substate) {
                        substate.data = (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .applyPatches */ .QE)(substate.data, patches.concat());
                    });
                },
                prepare: (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.prepareAutoBatched)()
            }
                ...
                updateQuerySubstateIfExists(draft, meta.arg.queryCacheKey, function (substate) {
                    ...
                    if (merge) {
                        if (substate.data !== void 0) {
                            ...
                            var newData = (0,immer__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(substate.data, function (draftSubstateData) {
                        ...
                        substate.data = ((_a = definitions[meta.arg.endpointName].structuralSharing) != null ? _a : true) ? copyWithStructuralSharing((0,immer__WEBPACK_IMPORTED_MODULE_1__/* .isDraft */ .mv)(substate.data) ? (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .original */ .Js)(substate.data) : substate.data, payload) : payload;
                    }
        ...
        reducers: {
            subscriptionsUpdated: {
                reducer: function (state, action) {
                    return (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .applyPatches */ .QE)(state, action.payload);
                },
                prepare: (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.prepareAutoBatched)()
            }
        }
    ...
    var combinedReducer = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_2__/* .combineReducers */ .UY)({
...
var defaultQuerySubState = /* @__PURE__ */ (0,immer__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(initialSubState, function () {
});
var defaultMutationSubState = /* @__PURE__ */ (0,immer__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP)(initialSubState, function () {
});
function buildSelectors(_j) {
    ...
    function buildQuerySelector(endpointName, endpointDefinition) {
        return function (queryArgs) {
            ...
            return (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__/* .createSelector */ .P1)(finalSelectQuerySubState, withRequestFlags);
        };
    }
    function buildMutationSelector() {
        return function (id) {
            ...
            return (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_3__/* .createSelector */ .P1)(finalSelectMutationSubstate, withRequestFlags);
        };
    }
...
function buildCreateApi() {
    ...
    return function baseCreateApi(options) {
        var extractRehydrationInfo = (0,reselect__WEBPACK_IMPORTED_MODULE_4__/* .defaultMemoize */ .PW)(function (action) {
            var _a, _b;
        ...
        var context = {
            ...
            extractRehydrationInfo: extractRehydrationInfo,
            hasRehydrationInfo: (0,reselect__WEBPACK_IMPORTED_MODULE_4__/* .defaultMemoize */ .PW)(function (action) { return extractRehydrationInfo(action) != null; })
        };
        var api = {
        ...
        if (didMutate) {
            if (!dispatchQueued) {
                queueMicrotaskShim(function () {
                    ...
                    var _j = (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .produceWithPatches */ .aS)(previousSubscriptions, function () { return newSubscriptions; }), patches = _j[1];
...
var coreModule = function () { return ({
    ...
    init: function (api, _j, context) {
        ...
        (0,immer__WEBPACK_IMPORTED_MODULE_1__/* .enablePatches */ .vI)();
...
__webpack_require__.d(__webpack_exports__, {
  ...
  __DO_NOT_USE__ActionTypes: function() { return /* reexport */ redux/* __DO_NOT_USE__ActionTypes */.Kf; },
  addListener: function() { return /* binding */ addListener; },
  applyMiddleware: function() { return /* reexport */ redux/* applyMiddleware */.md; },
  autoBatchEnhancer: function() { return /* binding */ autoBatchEnhancer; },
  bindActionCreators: function() { return /* reexport */ redux/* bindActionCreators */.DE; },
  clearAllListeners: function() { return /* binding */ clearAllListeners; },
  combineReducers: function() { return /* reexport */ redux/* combineReducers */.UY; },
  compose: function() { return /* reexport */ redux/* compose */.qC; },
  configureStore: function() { return /* binding */ configureStore; },
  createAction: function() { return /* binding */ createAction; },
  createActionCreatorInvariantMiddleware: function() { return /* binding */ createActionCreatorInvariantMiddleware; },
  ...
  createNextState: function() { return /* reexport */ immer_esm/* default */.ZP; },
  createReducer: function() { return /* binding */ createReducer; },
  createSelector: function() { return /* reexport */ es/* createSelector */.P1; },
  ...
  createStore: function() { return /* reexport */ redux/* createStore */.MT; },
  current: function() { return /* reexport */ immer_esm/* current */.Vk; },
  findNonSerializableValue: function() { return /* binding */ findNonSerializableValue; },
  freeze: function() { return /* reexport */ immer_esm/* freeze */.vV; },
  ...
  isActionCreator: function() { return /* binding */ isActionCreator; },
  ...
  isDraft: function() { return /* reexport */ immer_esm/* isDraft */.mv; },
...
var immer_esm = __webpack_require__(902);
// EXTERNAL MODULE: ./node_modules/redux/es/redux.js + 5 modules
var redux = __webpack_require__(791);
...
var createDraftSafeSelector = function () {
    ...
    var selector = es/* createSelector */.P1.apply(void 0, args);
    var wrappedSelector = function (value) {
        var rest = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            rest[_i - 1] = arguments[_i];
        }
        return selector.apply(void 0, __spreadArray([(0,immer_esm/* isDraft */.mv)(value) ? (0,immer_esm/* current */.Vk)(value) : value], rest));
    };
...
function createStateOperator(mutator) {
    return function operation(state, arg) {
        ...
        if ((0,immer_esm/* isDraft */.mv)(state)) {
            runMutator(state);
            return state;
        }
        else {
            return (0,immer_esm/* default */.ZP)(state, runMutator);
        }
    };
}
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  Kf: function() { return /* binding */ ActionTypes; },
  ...
  jB: function() { return /* binding */ legacy_createStore; }
});
...
/* harmony import */ var _defaultMemoize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(815);
...
/* harmony export */   Vk: function() { return /* binding */ R; },
...
/* harmony export */   vV: function() { return /* binding */ d; }
/* harmony export */ });
...
;// CONCATENATED MODULE: ./src/components/Filters/Break.tsx

function Break() {
    return ((0,jsx_runtime.jsx)("div", { className: "Break", children: (0,jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "321", height: "2", viewBox: "0 0 321 2", fill: "none", children: (0,jsx_runtime.jsx)("path", { d: "M1 1.06354H320", stroke: "black", strokeOpacity: "0.6", strokeLinecap: "round" }) }) }));
}
/* harmony default export */ var Filters_Break = (Break);

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(294);
// EXTERNAL MODULE: ./node_modules/react-redux/es/index.js + 23 modules
var es = __webpack_require__(113);
;// CONCATENATED MODULE: ./src/hooks/redux.ts

var useAppDispatch = function () { return (0,es.useDispatch)(); };
var useAppSelector = es.useSelector;

// EXTERNAL MODULE: ./node_modules/@reduxjs/toolkit/dist/redux-toolkit.esm.js + 1 modules
var redux_toolkit_esm = __webpack_require__(268);
;// CONCATENATED MODULE: ./src/store/reducers/FilterSlice.ts
...
var filterSlice = (0,redux_toolkit_esm.createSlice)({
    name: 'filters',
    initialState: initialState,
    reducers: {
        setFilters: function (state, action) {
            var _a = action.payload, filterName = _a.filterName, filterValue = _a.filterValue;
            state[filterName] = filterValue;
        }
    }
});
/* harmony default export */ var FilterSlice = (filterSlice.reducer);
var setFilters = filterSlice.actions.setFilters;

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterActivity.tsx




function FilterActivity() {
    var _a = (0,react.useState)(false), social = _a[0], setSocial = _a[1];
    var _b = (0,react.useState)(false), photo = _b[0], setPhoto = _b[1];
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsx)("div", { className: "checkBoxColumnLeft", children: (0,jsx_runtime.jsxs)("div", { className: "labelsBlock", children: [(0,jsx_runtime.jsx)("input", { onChange: handlePhotoChange, type: "checkbox", id: "photo", name: "photo" }), (0,jsx_runtime.jsx)("label", { htmlFor: "photo", children: "\u0421 \u0444\u043E\u0442\u043E\u0433\u0440\u0430\u0444\u0438\u0435\u0439" })] }) }) }));
}
/* harmony default export */ var Filter_FilterActivity = (FilterActivity);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterBlock.tsx

function FilterBlock(props) {
    return ((0,jsx_runtime.jsxs)("div", { className: "FilterBlock", children: [(0,jsx_runtime.jsx)("div", { className: "FilterName", children: props.name }), props.children] }));
}
/* harmony default export */ var Filter_FilterBlock = (FilterBlock);
...
/* harmony default export */ var hooks_useDebounce = (useDebounce);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterCity.tsx
...
function FilterCity() {
    var _a = (0,react.useState)(""), city = _a[0], setCity = _a[1];
    var dispatch = useAppDispatch();
    ...
    hooks_useDebounce(setFilterDebounce, 800, city);
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsx)("input", { onChange: handleCityChange, value: city, type: "text", placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435" }) }));
}
/* harmony default export */ var Filter_FilterCity = (FilterCity);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterCompany.tsx




function FilterCompany() {
    var _a = (0,react.useState)(""), company = _a[0], setCompany = _a[1];
    var dispatch = useAppDispatch();
    function handleCompanyChange(event) {
        if (event.target.checked) {
            setCompany(function (prev) { return prev + event.target.value + ";"; });
        }
        else {
            setCompany(function (prev) { return prev.replace(event.target.value + ";", ""); });
        }
    }
    (0,react.useEffect)(function () {
        dispatch(setFilters({ filterName: "company", filterValue: company }));
    }, [company, dispatch]);
    return ((0,jsx_runtime.jsxs)("div", { className: "filterContainer", children: [(0,jsx_runtime.jsxs)("div", { className: "checkBoxColumnLeft", children: [(0,jsx_runtime.jsxs)("div", { className: "labelsBlock", id: "labelsBlock_BD", children: [(0,jsx_runtime.jsx)("input", { onChange: handleCompanyChange, value: "7137262226269955805", type: "checkbox", id: "BD", name: "\u0411\u044B\u0441\u0442\u0440\u043E\u0434\u0435\u043D\u044C\u0433\u0438" }), (0,jsx_runtime.jsx)("label", { htmlFor: "BD", children: "\u0411\u044B\u0441\u0442\u0440\u043E\u0434\u0435\u043D\u044C\u0433\u0438" })] }), (0,jsx_runtime.jsxs)("div", { className: "labelsBlock", id: "labelsBlock_TZ", children: [(0,jsx_runtime.jsx)("input", { onChange: handleCompanyChange, value: "7137270169382290802", type: "checkbox", id: "TZ", name: "\u0422\u0443\u0440\u0431\u043E\u0437\u0430\u0439\u043C" }), (0,jsx_runtime.jsx)("label", { htmlFor: "TZ", children: "\u0422\u0443\u0440\u0431\u043E\u0437\u0430\u0439\u043C" })] })] }), (0,jsx_runtime.jsxs)("div", { className: "checkBoxColumnRight", children: [(0,jsx_runtime.jsxs)("div", { className: "labelsBlock", id: "labelsBlock_EqvantaLab", children: [(0,jsx_runtime.jsx)("input", { onChange: handleCompanyChange, value: "7137298841389065561", type: "checkbox", id: "SR", name: "EqvantaLab" }), (0,jsx_runtime.jsx)("label", { htmlFor: "SR", children: "EqvantaLab" })] }), (0,jsx_runtime.jsxs)("div", { className: "labelsBlock", id: "labelsBlock_SanoraRus", children: [(0,jsx_runtime.jsx)("input", { onChange: handleCompanyChange, value: "7137249226813999821", type: "checkbox", id: "EL", name: "\u0421\u0430\u043D\u043E\u0440\u0430\u0420\u0443\u0441" }), (0,jsx_runtime.jsx)("label", { htmlFor: "EL", children: "\u0421\u0430\u043D\u043E\u0440\u0430\u0420\u0443\u0441" })] })] })] }));
}
/* harmony default export */ var Filter_FilterCompany = (FilterCompany);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterDepartment.tsx




function FilterDepartment() {
    var _a = (0,react.useState)(""), department = _a[0], setDepartment = _a[1];
    var dispatch = useAppDispatch();
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsxs)("select", { onChange: handleDepartmentChange, value: department, name: "department", children: [(0,jsx_runtime.jsx)("option", { value: "", children: "\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" }), (0,jsx_runtime.jsx)("option", { value: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0441\u0442\u0432\u043E", children: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0441\u0442\u0432\u043E" }), (0,jsx_runtime.jsx)("option", { value: "\u041D\u0430\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0430\u043B\u044C\u0442\u0435\u0440\u043D\u0430\u0442\u0438\u0432\u043D\u044B\u0445 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u043E\u0432", children: "\u041D\u0430\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0430\u043B\u044C\u0442\u0435\u0440\u043D\u0430\u0442\u0438\u0432\u043D\u044B\u0445 \u043F\u0440\u043E\u0434\u0443\u043A\u0442\u043E\u0432" }), (0,jsx_runtime.jsx)("option", { value: "\u041E\u0442\u0434\u0435\u043B \u043F\u0440\u043E\u0435\u043A\u0442\u043D\u043E\u0433\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044F", children: "\u041E\u0442\u0434\u0435\u043B \u043F\u0440\u043E\u0435\u043A\u0442\u043D\u043E\u0433\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044F" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0431\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u043E\u0441\u0442\u0438", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0431\u0435\u0437\u043E\u043F\u0430\u0441\u043D\u043E\u0441\u0442\u0438" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0432\u0437\u044B\u0441\u043A\u0430\u043D\u0438\u044F", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0432\u0437\u044B\u0441\u043A\u0430\u043D\u0438\u044F" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u043E\u043D\u043D\u044B\u0445 \u0442\u0435\u0445\u043D\u043E\u043B\u043E\u0433\u0438\u0439", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u043E\u043D\u043D\u044B\u0445 \u0442\u0435\u0445\u043D\u043E\u043B\u043E\u0433\u0438\u0439" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043A\u043B\u0438\u0435\u043D\u0442\u0441\u043A\u043E\u0433\u043E \u0441\u0435\u0440\u0432\u0438\u0441\u0430", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043A\u043B\u0438\u0435\u043D\u0442\u0441\u043A\u043E\u0433\u043E \u0441\u0435\u0440\u0432\u0438\u0441\u0430" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043C\u0430\u0440\u043A\u0435\u0442\u0438\u043D\u0433\u0430", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043C\u0430\u0440\u043A\u0435\u0442\u0438\u043D\u0433\u0430" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043C\u0435\u0436\u0434\u0443\u043D\u0430\u0440\u043E\u0434\u043D\u043E\u0433\u043E \u0431\u0438\u0437\u043D\u0435\u0441\u0430", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043C\u0435\u0436\u0434\u0443\u043D\u0430\u0440\u043E\u0434\u043D\u043E\u0433\u043E \u0431\u0438\u0437\u043D\u0435\u0441\u0430" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043F\u043E \u043F\u0440\u0430\u0432\u043E\u0432\u044B\u043C \u0438 \u043A\u043E\u0440\u043F\u043E\u0440\u0430\u0442\u0438\u0432\u043D\u044B\u043C \u0432\u043E\u043F\u0440\u043E\u0441\u0430\u043C", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043F\u043E \u043F\u0440\u0430\u0432\u043E\u0432\u044B\u043C \u0438 \u043A\u043E\u0440\u043F\u043E\u0440\u0430\u0442\u0438\u0432\u043D\u044B\u043C \u0432\u043E\u043F\u0440\u043E\u0441\u0430\u043C" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E \u043F\u0435\u0440\u0441\u043E\u043D\u0430\u043B\u043E\u043C", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u043F\u043E \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u044E \u043F\u0435\u0440\u0441\u043E\u043D\u0430\u043B\u043E\u043C" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0440\u0438\u0441\u043A\u043E\u0432", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0440\u0438\u0441\u043A\u043E\u0432" }), (0,jsx_runtime.jsx)("option", { value: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0440\u043E\u0437\u043D\u0438\u0447\u043D\u043E\u0433\u043E \u0431\u0438\u0437\u043D\u0435\u0441\u0430", children: "\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442 \u0440\u043E\u0437\u043D\u0438\u0447\u043D\u043E\u0433\u043E \u0431\u0438\u0437\u043D\u0435\u0441\u0430" }), (0,jsx_runtime.jsx)("option", { value: "\u0424\u0438\u043D\u0430\u043D\u0441\u043E\u0432\u044B\u0439 \u0434\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442", children: "\u0424\u0438\u043D\u0430\u043D\u0441\u043E\u0432\u044B\u0439 \u0434\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442" })] }) }));
}
/* harmony default export */ var Filter_FilterDepartment = (FilterDepartment);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterEmail.tsx
...
function FilterEmail() {
    ...
    hooks_useDebounce(setFilterDebounce, 800, email);
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsx)("input", { onChange: handleEmailChange, value: email, type: "text", placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435" }) }));
}
/* harmony default export */ var Filter_FilterEmail = (FilterEmail);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterMobileButton.tsx

function FilterMobileButton() {
    function handleHideFilter() {
        var filterDiv = document.querySelector(".MainFilter");
        filterDiv.classList.remove("MainFilterView");
        var bgMask = document.querySelector("#get_report_mask");
        if (bgMask)
            bgMask.classList.remove("maskShowed");
    }
    return ((0,jsx_runtime.jsx)("div", { className: "FilterMobileButton", onClick: handleHideFilter, children: "\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B" }));
}
/* harmony default export */ var Filter_FilterMobileButton = (FilterMobileButton);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterPosition.tsx
...
function FilterPosition() {
    var _a = (0,react.useState)(""), position = _a[0], setPosition = _a[1];
    var dispatch = useAppDispatch();
    ...
    hooks_useDebounce(setFilterDebounce, 800, position);
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsx)("input", { onChange: handlePositionChange, value: position, type: "text", placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435" }) }));
}
/* harmony default export */ var Filter_FilterPosition = (FilterPosition);
function setEmail(value) {
    throw new Error("Function not implemented.");
}

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterSex.tsx




function FilterSex() {
    var _a = (0,react.useState)(""), sex = _a[0], setSex = _a[1];
    var dispatch = useAppDispatch();
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsxs)("select", { onChange: handleChangeSex, value: sex, name: "sex", children: [(0,jsx_runtime.jsx)("option", { value: "", children: "\u041D\u0435 \u0432\u044B\u0431\u0440\u0430\u043D\u043E" }), (0,jsx_runtime.jsx)("option", { value: "m", children: "\u041C\u0443\u0436\u0441\u043A\u043E\u0439" }), (0,jsx_runtime.jsx)("option", { value: "w", children: "\u0416\u0435\u043D\u0441\u043A\u0438\u0439" })] }) }));
}
/* harmony default export */ var Filter_FilterSex = (FilterSex);

;// CONCATENATED MODULE: ./src/components/Filters/Filter/FilterSubdivison.tsx
...
function FilterSubdivision() {
    var _a = (0,react.useState)(""), subdiv = _a[0], setSubdiv = _a[1];
    var dispatch = useAppDispatch();
    function handleSubdiv(event) {
        setSubdiv(event.target.value);
    }
    function setFilterDebounce() {
        dispatch(setFilters({ filterName: "subdivision", filterValue: subdiv }));
    }
    hooks_useDebounce(setFilterDebounce, 800, subdiv);
    return ((0,jsx_runtime.jsx)("div", { className: "filterContainer", children: (0,jsx_runtime.jsx)("input", { value: subdiv, onChange: handleSubdiv, type: "text", placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435" }) }));
}
/* harmony default export */ var FilterSubdivison = (FilterSubdivision);

;// CONCATENATED MODULE: ./src/icons/CloseIcon.tsx
...
function CloseIcon() {
    ...
    return ((0,jsx_runtime.jsx)("div", { className: "CloseIcon", children: (0,jsx_runtime.jsxs)("svg", { onClick: handleHideFilter, xmlns: "http://www.w3.org/2000/svg", width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", children: [(0,jsx_runtime.jsx)("rect", { width: "15", height: "15", rx: "4", fill: "#E7E7E7" }), (0,jsx_runtime.jsx)("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M10.0327 5.85411C10.2283 5.65915 10.2288 5.34257 10.0338 5.147C9.83888 4.95143 9.5223 4.95094 9.32673 5.14589L7.58987 6.87733L5.853 5.14589C5.65743 4.95094 5.34085 4.95143 5.14589 5.147C4.95094 5.34257 4.95143 5.65915 5.147 5.85411L6.88165 7.58333L5.147 9.31256C4.95143 9.50752 4.95094 9.8241 5.14589 10.0197C5.34085 10.2152 5.65743 10.2157 5.853 10.0208L7.58987 8.28934L9.32673 10.0208C9.5223 10.2157 9.83888 10.2152 10.0338 10.0197C10.2288 9.8241 10.2283 9.50752 10.0327 9.31256L8.29808 7.58333L10.0327 5.85411Z", fill: "#808080" })] }) }));
}
/* harmony default export */ var icons_CloseIcon = (CloseIcon);

;// CONCATENATED MODULE: ./src/components/Filters/Header/HeaderIcon.tsx

function HeaderIcon() {
    return ((0,jsx_runtime.jsx)("div", { className: "HeaderIcon", children: (0,jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "20", height: "14", viewBox: "0 0 20 14", fill: "none", children: (0,jsx_runtime.jsx)("path", { d: "M0.625 3.60326H10.1408C10.4276 4.92262 11.5934 5.91312 12.9837 5.91312C14.374 5.91312 15.5398 4.92266 15.8266 3.60326H19.375C19.7202 3.60326 20 3.32042 20 2.97158C20 2.62274 19.7202 2.33991 19.375 2.33991H15.8263C15.5389 1.02122 14.3716 0.0300903 12.9837 0.0300903C11.5951 0.0300903 10.4283 1.02106 10.1411 2.33991H0.625C0.279844 2.33991 0 2.62274 0 2.97158C0 3.32042 0.279844 3.60326 0.625 3.60326ZM11.3233 2.97324C11.3233 2.97099 11.3234 2.9687 11.3234 2.96645C11.3261 2.04394 12.0709 1.29347 12.9837 1.29347C13.8952 1.29347 14.6401 2.04291 14.644 2.96499L14.6441 2.97427C14.6427 3.89836 13.8984 4.64982 12.9837 4.64982C12.0694 4.64982 11.3254 3.89911 11.3233 2.97557L11.3233 2.97324ZM19.375 9.51495H9.85918C9.57238 8.19558 8.4066 7.20512 7.01629 7.20512C5.62598 7.20512 4.4602 8.19558 4.1734 9.51495H0.625C0.279844 9.51495 0 9.79777 0 10.1466C0 10.4955 0.279844 10.7783 0.625 10.7783H4.17371C4.46109 12.0969 5.62844 13.0881 7.01629 13.0881C8.40488 13.0881 9.57172 12.0971 9.85895 10.7783H19.375C19.7202 10.7783 20 10.4955 20 10.1466C20 9.79777 19.7202 9.51495 19.375 9.51495ZM8.67668 10.145C8.67668 10.1472 8.67664 10.1495 8.67664 10.1517C8.67391 11.0743 7.9291 11.8247 7.01629 11.8247C6.10477 11.8247 5.35992 11.0753 5.35598 10.1532L5.35586 10.144C5.35723 9.2198 6.10156 8.46846 7.01629 8.46846C7.93059 8.46846 8.67465 9.21912 8.67672 10.1427L8.67668 10.145Z", fill: "black" }) }) }));
}
/* harmony default export */ var Header_HeaderIcon = (HeaderIcon);

;// CONCATENATED MODULE: ./src/components/Filters/Header/HeaderTitle.tsx

function HeaderTitle() {
    return (0,jsx_runtime.jsx)("div", { className: "HeaderTitle", children: "\u041F\u0430\u0440\u0430\u043C\u0435\u0442\u0440\u044B \u043F\u043E\u0438\u0441\u043A\u0430" });
}
/* harmony default export */ var Header_HeaderTitle = (HeaderTitle);

;// CONCATENATED MODULE: ./src/components/Filters/Header/HeaderFilter.tsx




function HeaderFilter() {
    return ((0,jsx_runtime.jsxs)("div", { className: "HeaderFilter", children: [(0,jsx_runtime.jsx)(Header_HeaderIcon, {}), (0,jsx_runtime.jsx)(Header_HeaderTitle, {}), (0,jsx_runtime.jsx)(icons_CloseIcon, {})] }));
}
/* harmony default export */ var Header_HeaderFilter = (HeaderFilter);

;// CONCATENATED MODULE: ./src/components/Filters/MainFilter.tsx
...
function MainFilter() {
    return ((0,jsx_runtime.jsxs)("div", { className: "MainFilter", children: [(0,jsx_runtime.jsx)(Header_HeaderFilter, {}), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Пол", children: (0,jsx_runtime.jsx)(Filter_FilterSex, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Город", children: (0,jsx_runtime.jsx)(Filter_FilterCity, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Компания", children: (0,jsx_runtime.jsx)(Filter_FilterCompany, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Департамент", children: (0,jsx_runtime.jsx)(Filter_FilterDepartment, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Подразделение", children: (0,jsx_runtime.jsx)(FilterSubdivison, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Должность", children: (0,jsx_runtime.jsx)(Filter_FilterPosition, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "E-mail", children: (0,jsx_runtime.jsx)(Filter_FilterEmail, {}) }), (0,jsx_runtime.jsx)(Filters_Break, {}), (0,jsx_runtime.jsx)(Filter_FilterBlock, { name: "Активность", children: (0,jsx_runtime.jsx)(Filter_FilterActivity, {}) }), (0,jsx_runtime.jsx)(Filter_FilterMobileButton, {})] }));
}
/* harmony default export */ var Filters_MainFilter = (MainFilter);

;// CONCATENATED MODULE: ./src/icons/SearchIcon.tsx

function SearchIcon() {
    return ((0,jsx_runtime.jsx)("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 18 18", fill: "none", children: (0,jsx_runtime.jsx)("path", { d: "M11.6254 11.6185L17 17M13.4444 7.22222C13.4444 10.6587 10.6587 13.4444 7.22222 13.4444C3.78579 13.4444 1 10.6587 1 7.22222C1 3.78579 3.78579 1 7.22222 1C10.6587 1 13.4444 3.78579 13.4444 7.22222Z", stroke: "#878787", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }));
}
/* harmony default export */ var icons_SearchIcon = (SearchIcon);

;// CONCATENATED MODULE: ./src/icons/FilterIcon.tsx
...
function SearcInput() {
    var _a = (0,react.useState)(""), textName = _a[0], setTextName = _a[1];
    var dispatch = useAppDispatch();
    ...
    hooks_useDebounce(setFilterDebounce, 800, textName);
    return ((0,jsx_runtime.jsxs)("div", { className: "SearchBlock", id: "SearchBlock_guide", children: [(0,jsx_runtime.jsx)("div", { className: "searchIcon", children: (0,jsx_runtime.jsx)(icons_SearchIcon, {}) }), (0,jsx_runtime.jsx)("input", { value: textName, onChange: handleChangeName, placeholder: "\u041F\u043E\u0438\u0441\u043A", className: "SearchInput", type: "text", id: "SearchInput_white" }), (0,jsx_runtime.jsx)("div", { className: "filterIcon", children: (0,jsx_runtime.jsx)(icons_FilterIcon, {}) })] }));
}
/* harmony default export */ var Users_SearcInput = (SearcInput);

// EXTERNAL MODULE: ./node_modules/@reduxjs/toolkit/dist/query/react/rtk-query-react.cjs.production.min.js
var rtk_query_react_cjs_production_min = __webpack_require__(378);
;// CONCATENATED MODULE: ./src/services/userService.ts
//import { BaseQueryArg } from '@reduxjs/toolkit/dist/query/baseQueryTypes'

var userAPI = (0,rtk_query_react_cjs_production_min.createApi)({
    reducerPath: 'userAPI',
    baseQuery: (0,rtk_query_react_cjs_production_min.fetchBaseQuery)({ baseUrl: '/custom_web_template.html' }),
    endpoints: function (build) { return ({
        fetchAllUsers: build.query({
            query: function (filter) { return ({
...
;// CONCATENATED MODULE: ./src/store/reducers/UserSlice.ts
...
var userSlice = (0,redux_toolkit_esm.createSlice)({
    name: 'users',
...
/* harmony default export */ var UserSlice = (userSlice.reducer);
var setUsers = userSlice.actions.setUsers;

;// CONCATENATED MODULE: ./src/components/Users/UserCard/UserInfo.tsx


function UserInfo(props) {
    var _a = (0,react.useState)(props.name), name = _a[0], setName = _a[1];
    return ((0,jsx_runtime.jsxs)("div", { className: "UserInfo", children: [(0,jsx_runtime.jsx)("div", { className: "userName", id: "userName_catalog", children: (0,jsx_runtime.jsx)("a", { href: "/_wt/".concat(props.id), target: "_blank", children: "".concat(props.name.split(" ")[1], " ").concat(props.name.split(" ")[0]) }) }), (0,jsx_runtime.jsxs)("div", { className: "userProp", id: "userProp_number1", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C:" }), (0,jsx_runtime.jsx)("div", { className: "userValue", id: "userValue_number1", children: props.position })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F:" }), (0,jsx_runtime.jsx)("div", { className: "userValue", children: props.company })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u041F\u043E\u0434\u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435:" }), (0,jsx_runtime.jsx)("div", { className: "userValue", children: props.subdivision })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u0413\u043E\u0440\u043E\u0434:" }), (0,jsx_runtime.jsx)("div", { className: "userValue", children: props.city ? props.city : "Не указан" })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "Email:" }), (0,jsx_runtime.jsx)("div", { className: "userValue", children: props.email })] })] }));
}
/* harmony default export */ var UserCard_UserInfo = (UserInfo);

;// CONCATENATED MODULE: ./src/components/Users/UserCard/UserPhoto.tsx

function UserPhoto(_a) {
    var id = _a.id;
    return ((0,jsx_runtime.jsx)("div", { className: "UserPhoto", children: (0,jsx_runtime.jsx)("img", { className: "userImage", width: "160", height: "160", "data-src": "/person_icon.html?id=".concat(id, "&type=250x250"), alt: "" }) }));
}
/* harmony default export */ var UserCard_UserPhoto = (UserPhoto);

;// CONCATENATED MODULE: ./src/components/Users/UserCard/Card.tsx



function Card(props) {
    return ((0,jsx_runtime.jsxs)("div", { className: "userCard", children: [(0,jsx_runtime.jsx)(UserCard_UserPhoto, { id: props.id }), (0,jsx_runtime.jsx)(UserCard_UserInfo, { name: props.name, email: props.email, id: props.id, city: props.city, company: props.company, department: props.department, position: props.position, subdivision: props.subdivision })] }));
}
/* harmony default export */ var UserCard_Card = (Card);

;// CONCATENATED MODULE: ./src/components/Users/UserCard/SkeletonCard.tsx

function SkeletonCard() {
    return ((0,jsx_runtime.jsxs)("div", { className: "userCard", children: [(0,jsx_runtime.jsx)("div", { className: "UserPhotoSkelet" }), (0,jsx_runtime.jsxs)("div", { className: "UserInfo", children: [(0,jsx_runtime.jsx)("div", { className: "userNameSkelet" }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C:" }), (0,jsx_runtime.jsx)("div", { className: "userValueSkelet" })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F:" }), (0,jsx_runtime.jsx)("div", { className: "userValueSkelet" })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u041F\u043E\u0434\u0440\u0430\u0437\u0434\u0435\u043B\u0435\u043D\u0438\u0435:" }), (0,jsx_runtime.jsx)("div", { className: "userValueSkelet" })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "\u0413\u043E\u0440\u043E\u0434:" }), (0,jsx_runtime.jsx)("div", { className: "userValueSkelet" })] }), (0,jsx_runtime.jsxs)("div", { className: "userProp", children: [(0,jsx_runtime.jsx)("div", { className: "userTitle", children: "Email:" }), (0,jsx_runtime.jsx)("div", { className: "userValueSkelet" })] })] })] }));
}
/* harmony default export */ var UserCard_SkeletonCard = (SkeletonCard);

;// CONCATENATED MODULE: ./src/components/Users/MainResults.tsx
...
function MainResults() {
    var dispatch = useAppDispatch();
    var mainFilter = useAppSelector(function (state) { return state.filterReducer; });
    function checkFilter(mainFilter) {
        return Object.values(mainFilter).every(function (value) { return !value; });
    }
    var _a = userAPI.useFetchAllUsersQuery(mainFilter, {
        skip: checkFilter(mainFilter),
    }), newUsers = _a.data, isFetching = _a.isFetching, error = _a.error;
    var users = useAppSelector(function (state) { return state.userReducer.filteredUsers; });
    (0,react.useEffect)(function () {
        document.addEventListener("scroll", lazyLoadImages);
        return function () { return document.removeEventListener("scroll", lazyLoadImages); };
    }, []);
    (0,react.useEffect)(function () {
        if (newUsers) {
    ...
    return ((0,jsx_runtime.jsxs)("div", { className: "MainResults", children: [(0,jsx_runtime.jsx)(Users_SearcInput, {}), isFetching && ((0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [(0,jsx_runtime.jsx)(UserCard_SkeletonCard, {}), (0,jsx_runtime.jsx)(UserCard_SkeletonCard, {}), (0,jsx_runtime.jsx)(UserCard_SkeletonCard, {})] })), error && (0,jsx_runtime.jsx)("h1", { children: "\u041F\u0440\u0438 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0435 \u043F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430 \u043E\u0448\u0438\u0431\u043A\u0430" }), !isFetching &&
                !checkFilter(mainFilter) &&
                newUsers &&
                newUsers.map(function (user) { return ((0,jsx_runtime.jsx)(UserCard_Card, { name: user.name, email: user.email, id: user.id, city: user.city, company: user.company, department: user.department, position: user.position, sex: user.sex, subdivision: user.subdivision, photo: user.photo, social: user.social }, user.id)); })] }));
}
/* harmony default export */ var Users_MainResults = (MainResults);
...
function App() {
    return ((0,jsx_runtime.jsxs)("div", { className: "userCatalog", children: [(0,jsx_runtime.jsx)(Filters_MainFilter, {}), (0,jsx_runtime.jsx)(Users_MainResults, {})] }));
}
...
var rootReducer = (0,redux/* combineReducers */.UY)((_a = {
        userReducer: UserSlice
    },
    _a[userAPI.reducerPath] = userAPI.reducer,
    _a.filterReducer = FilterSlice,
    _a));
var setupStore = function () {
    return (0,redux_toolkit_esm.configureStore)({
        reducer: rootReducer,
        middleware: function (getDefaultMiddleware) { return getDefaultMiddleware().concat(userAPI.middleware); }
    });
};
...
var root = client.createRoot(document.getElementById("catalog_root"));
var store = setupStore();
root.render((0,jsx_runtime.jsx)(es.Provider, { store: store, children: (0,jsx_runtime.jsx)(components_App, {}) }));
